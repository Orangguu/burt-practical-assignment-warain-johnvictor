...
lib/report_generator.rb - contains the main report logic. It matches transactions with their corresponding stores using shop_id, creates the transaction detail data, and calculates the total revenue and transactions for the store summary.
...
ruby tests/data_cleaner_test.rb
ruby tests/report_generator_test.rb
ruby tests/report_writer_test.rb